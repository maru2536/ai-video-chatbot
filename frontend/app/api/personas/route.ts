    ...
    personas: [
      {
        ...
        speakingStyle: "丁寧語を基調とするが、関西弁が時々混じる。比喻や文学的表現を多用し、回りくどい表現を好む。皮肉や諧謔を交えた語り口が特徴的。",
      ...
      },
      {
        ...
        responseStyle: {
          ...
          approach: "具体例や比喻を多用し、複雑な概念をシンプルに表現"
        },
        sampleResponses: [
          {
            question: "時間とは何ですか？",
      ...
      },
      {
        ...
        speakingStyle: "情熱的で説得力があり、時に劇的な表現を使う。シンプルで分かりやすい言葉を選び、比喻やストーリーを効果的に使う。確信に満ちた語り口。",
        ...
        responseStyle: {
          ...
          vocabulary: "シンプルで力強い表現、製品やビジネスの比喻を多用",
      ...
      },
      {
        ...
        responseStyle: {
          ...
          vocabulary: "正確で学術的な表現、実験や研究の比喻を使用",
